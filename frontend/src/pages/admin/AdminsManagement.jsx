...
import { FiLock, FiCheck, FiX, FiTrash2 } from "react-icons/fi";
    ...
    <div>
      ...
      <div className="admin-table-wrapper">
        <div className="admin-table-header">
          ...
          <button className="admin-btn admin-btn-primary" onClick={() => { setForm({ ...emptyAdmin }); setShowForm(true); }}>
            + Register Admin
          </button>
        </div>
            ...
            <tbody>
              {admins.map((a) => (
                <tr key={a._id}>
                  ...
                  <td>{a.email}</td>
                  <td>
                    <span className={`status-badge ${a.role === "super_admin" ? "confirmed" : "draft"}`}>
                      {a.role?.replace("_", " ")}
                    </span>
                  </td>
                  <td>
                  ...
                  <td>
                    <div className="admin-actions">
                      ...
                      {a._id !== currentAdmin?.id && (
                        <button className="admin-btn-icon" title="Delete" onClick={() => handleDelete(a._id)}>
                          <FiTrash2 />
                        </button>
                      )}
                    </div>
